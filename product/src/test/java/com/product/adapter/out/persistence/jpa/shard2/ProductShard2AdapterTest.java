...
class ProductShard2AdapterTest extends IntegrationTestSupport {

    @Autowired
    ProductShard2Adapter adapter;

    @Autowired
    ProductShard2Repository productRepository;

    @Autowired
    ProductMetricShard2Repository metricRepository;
    ...
    class Describe_register {
        ...
        void success() {
            ...
            ProductShard2Entity productEntity = productRepository
                .findById(product.getId()).get();
            ProductMetricShard2Entity metricEntity = metricRepository
                .findById(product.getId()).get();
