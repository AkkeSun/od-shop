...
public class RegisterReviewDocsTest extends RestDocsSupport {

    RegisterReviewUseCase registerReviewUseCase =
        mock(RegisterReviewUseCase.class);
    ...
    class Describe_registerReview {
        ...
        void success() throws Exception {
            ...
            Long productId = 1L;
            when(registerReviewUseCase.registerReview(any()))
                .thenReturn(RegisterReviewServiceResponse.ofSuccess());
    ...
    private void performAndDocument(RegisterReviewRequest request, String authorization,
        ...
        JsonFieldType commentType =
            request.review() == null ? JsonFieldType.NULL : JsonFieldType.STRING;
        ...
        mockMvc.perform(post("/products/{productId}/reviews", productId)
            ...
            .andDo(print())
            .andExpect(status)
            .andDo(MockMvcRestDocumentationWrapper.document("[register-reviews] " + docIdentifier,
                    ...
                    resource(ResourceSnippetParameters.builder()
                        ...
                        .requestFields(
                            fieldWithPath("review").type(commentType)
    ...
    private void performErrorDocument(RegisterReviewRequest request, String authorization,
