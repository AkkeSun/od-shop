...
public class IncreaseProductQuantityDocsTest extends RestDocsSupport {

    private final IncreaseProductQuantityUseCase useCase = mock(
        IncreaseProductQuantityUseCase.class);

    @Override
    protected Object initController() {
        return new IncreaseProductQuantityController(useCase);
    }
    ...
    private void performDocument(IncreaseProductQuantityRequest request, Long productId,
        String authorization,
        ResultMatcher status, String docIdentifier, String responseSchema,
        FieldDescriptor... responseFields)
        throws Exception {

        mockMvc.perform(put("/products/{productId}/restock", productId)
            ...
            .andDo(MockMvcRestDocumentationWrapper.document(
                    "[increase-product-quantity] " + docIdentifier,
                    preprocessRequest(prettyPrint()),
                    preprocessResponse(prettyPrint()),
                    resource(ResourceSnippetParameters.builder()
                        .tag("Product")
                        .summary("상품 수량 추가 API")
                        .description("상품 수량을 추가하는 API 입니다. <br><br>"
                        ...
                        .requestSchema(Schema.schema("[request] increase-product-quantity"))
    ...
    private void performErrorDocument(IncreaseProductQuantityRequest request, Long productId,
