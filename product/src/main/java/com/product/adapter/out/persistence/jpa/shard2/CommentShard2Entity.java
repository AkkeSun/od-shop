...
class CommentShard2Entity {
    ...
    @Builder
    CommentShard2Entity(String comment, String customerEmail, Long customerId, Long id,
    ...
    static CommentShard2Entity of(Comment comment) {
        return CommentShard2Entity.builder()
            .id(comment.id())
